  ...
  const handleProductSubmit = async (e) => {
    ...
    try {
      ...
      const productPayload = {
        ...productForm,
        kitItems: cleanedKitItems,
      };

      if (productForm._id) {
        await updateProduct(productForm._id, productPayload);
    ...
    const openEditModal = (product) => {
      setProductForm({
        ...
        kitItems: product.kitItems && product.kitItems.length > 0
          ? product.kitItems
          : [{ name: "", quantity: "" }],
      });
      setShowModal(true);
            ...
            <div className="modal-dialog modal-lg modal-dialog-centered">
              <div className="modal-content">
                ...
                <div className="modal-body">
                  <form onSubmit={handleProductSubmit} className="p-3 border rounded bg-white">
                    <div className="mb-3">
                        ...
                        <div className="row mb-2" key={idx}>
                          ...
                          <div className="col-md-4">
                            <input
                              ...
                              value={item.quantity}
                              onChange={(e) =>
                                handleKitItemChange(idx, "quantity", e.target.value)
                              }
                              min="1"
                              required
                            />
